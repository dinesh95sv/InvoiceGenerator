...
function CustomerListItem({ customer }: CustomerListItem) {
  ...
  return (
    <View style={styles.container}>
      <Modal
        ...
        <View style={styles.centredView}>
          <View style={styles.modalView}>
            <Text style={styles.label}>Edit Customer Info</Text>
      ...
      <View>
        ...
        <View>
          <Text style={styles.others}>{customer.gstin}</Text>
        </View>
        <View style={styles.details}>
          <Text style={styles.othersText}>Phone:</Text>
          <Text style={styles.others}>{customer.phone}</Text>
        </View>
        {customer.email &&
        <View style={styles.details}>
          <Text style={styles.othersText}>Email:</Text>
          <Text style={styles.others}>{customer.email}</Text> 
        </View>
        }
        {customer.address &&
        <View style={styles.details}>
          <Text style={styles.othersText}>Address:</Text>
          <Text style={styles.others}>{customer.address}</Text>
        </View>
        }
      </View>
      <View style={styles.buttons}>
        ...
        <View style={styles.editIcon}>
          <Ionicons name="pencil-sharp" size={18} color="green" onPress={onEdit}/>
        </View>
      </View>
    </View>
  );
...
export default enhance(CustomerListItem);
